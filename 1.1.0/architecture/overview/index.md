...
1. **Tracking spend** in a thread- and async-safe way via `ContextVar`
1. **Enforcing limits** (USD, call count, tool count, or temporal windows) before or after each intercepted call
1. **Restoring** original SDK methods when the last budget context exits (ref-counted)
...
Next: [Core Components](https://arieradle.github.io/shekel/1.1.0/architecture/components/index.md)
