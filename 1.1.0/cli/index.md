...
See [Docker & Container Guardrails](https://arieradle.github.io/shekel/1.1.0/docker/index.md) for container-specific patterns.
...
- [Docker & Container Guardrails](https://arieradle.github.io/shekel/1.1.0/docker/index.md) - Using `shekel run` in Docker
- [Supported Models](https://arieradle.github.io/shekel/1.1.0/models/index.md) - Full model list with pricing
- [Installation](https://arieradle.github.io/shekel/1.1.0/installation/index.md) - Installing CLI tools
