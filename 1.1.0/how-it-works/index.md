...
1. **ContextVar isolation** - Thread-safe per-context tracking
1. **Ref-counted patching** - Efficient nested context handling
...
To add a new provider, implement `ProviderAdapter` and register it — see [Extending Shekel](https://arieradle.github.io/shekel/1.1.0/extending/index.md).
...
1. **No initialization** - Just import and use
...
1. **Cross-provider fallback**: Can't switch from OpenAI to Anthropic
1. **Predict costs**: Only tracks actual usage
1. **Batch API**: Doesn't support OpenAI batch endpoints
1. **Function calling costs**: Tracks tokens but not function execution costs
...
- [Extending Shekel](https://arieradle.github.io/shekel/1.1.0/extending/index.md) - Add new providers or models
- [Contributing](https://arieradle.github.io/shekel/1.1.0/contributing/index.md) - Contribute to the project
- [API Reference](https://arieradle.github.io/shekel/1.1.0/api-reference/index.md) - Complete API docs
