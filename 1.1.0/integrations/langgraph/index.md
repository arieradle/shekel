...
1. **Reuse budget variables** for multi-turn conversations (they accumulate automatically)
1. **Set fallback models** to prevent graph crashes
1. **Monitor retry loops** with budget caps
1. **Test with low budgets** to catch runaway costs early

## Next Steps

- [CrewAI Integration](https://arieradle.github.io/shekel/1.1.0/integrations/crewai/index.md)
- [OpenAI Integration](https://arieradle.github.io/shekel/1.1.0/integrations/openai/index.md)
