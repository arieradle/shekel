...
1. **Wrap at the workflow level**, not per-call, for accurate total cost tracking
1. **Set `warn_at=0.8`** to log a warning before the budget cap triggers
1. **Gemini free tier has per-minute limits** — use exponential backoff for production workloads

## Next Steps

- [HuggingFace Integration](https://arieradle.github.io/shekel/1.1.0/integrations/huggingface/index.md)
- [Nested Budgets](https://arieradle.github.io/shekel/1.1.0/usage/nested-budgets/index.md)
- [Fallback Models](https://arieradle.github.io/shekel/1.1.0/usage/fallback-models/index.md)
