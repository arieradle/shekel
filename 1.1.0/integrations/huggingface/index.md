...
1. **Use non-streaming calls for accurate cost tracking** — many models omit usage in streaming
1. **Check model availability** — not all models are available on HuggingFace's serverless API
1. **Handle 503 errors** — free-tier endpoints can be temporarily unavailable under load
1. **Use `max_tokens`** to cap response length and control costs

## Next Steps

- [Google Gemini Integration](https://arieradle.github.io/shekel/1.1.0/integrations/gemini/index.md)
- [Nested Budgets](https://arieradle.github.io/shekel/1.1.0/usage/nested-budgets/index.md)
- [Budget Enforcement](https://arieradle.github.io/shekel/1.1.0/usage/budget-enforcement/index.md)
- [Extending Shekel](https://arieradle.github.io/shekel/1.1.0/extending/index.md)
