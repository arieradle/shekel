...
- [Loop Guard](https://arieradle.github.io/shekel/1.1.0/usage/loop-guard/index.md) — detect repeated tool calls
- [Temporal Budgets](https://arieradle.github.io/shekel/1.1.0/usage/temporal-budgets/index.md) — rolling-window rate limits for multi-process deployments
