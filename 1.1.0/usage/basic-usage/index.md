...
- **[Loop Guard](https://arieradle.github.io/shekel/1.1.0/usage/loop-guard/index.md)** — detect and stop infinite tool-call loops before they drain your budget
- **[Spend Velocity](https://arieradle.github.io/shekel/1.1.0/usage/spend-velocity/index.md)** — cap burn rate so a bursty agent can't blow through `max_usd` in seconds
- **[Tool Budgets](https://arieradle.github.io/shekel/1.1.0/usage/tool-budgets/index.md)** — cap total tool dispatches and charge per-tool

**Go deeper:**

- **[Budget Enforcement](https://arieradle.github.io/shekel/1.1.0/usage/budget-enforcement/index.md)** — hard caps, warnings, and `warn_only` mode
- **[Fallback Models](https://arieradle.github.io/shekel/1.1.0/usage/fallback-models/index.md)** — automatic model switching instead of crashing
- **[Nested Budgets](https://arieradle.github.io/shekel/1.1.0/usage/nested-budgets/index.md)** — per-stage limits for multi-step pipelines
- **[Accumulating Budgets](https://arieradle.github.io/shekel/1.1.0/usage/accumulating-budgets/index.md)** — multi-session tracking
- **[CLI Reference](https://arieradle.github.io/shekel/1.1.0/cli/index.md)** — `shekel run` for code-free enforcement
- **[API Reference](https://arieradle.github.io/shekel/1.1.0/api-reference/index.md)** — complete parameter reference
