...
- [Spend Velocity](https://arieradle.github.io/shekel/1.1.0/usage/spend-velocity/index.md) — burn-rate circuit breaker
- [Tool Budgets](https://arieradle.github.io/shekel/1.1.0/usage/tool-budgets/index.md) — cap total tool calls and charge per tool
