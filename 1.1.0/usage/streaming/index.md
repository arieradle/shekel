...
Cost Checked After Stream

With streaming, shekel can only check the budget **after** the full stream completes. The stream will complete even if it exceeds the budget, and the error is raised afterward. Use [fallback models](https://arieradle.github.io/shekel/1.1.0/usage/fallback-models/index.md) for better control.
...
1. **Cannot stop mid-stream**: Once started, the stream completes even if it will exceed budget
1. **Full cost charged**: Even if you stop consuming the stream early, you're charged for all generated tokens
...
- **[Decorators](https://arieradle.github.io/shekel/1.1.0/usage/decorators/index.md)** - Using @with_budget for cleaner code
- **[Basic Usage](https://arieradle.github.io/shekel/1.1.0/usage/basic-usage/index.md)** - Non-streaming examples
- **[API Reference](https://arieradle.github.io/shekel/1.1.0/api-reference/index.md)** - Complete streaming parameters
