...
Run a Python script with budget enforcement. Equivalent to wrapping your script in `with budget(max_usd=N):` — zero code changes required.
...
See [Docker & Container Guardrails](https://arieradle.github.io/shekel/1.2.0/docker/index.md) for container-specific patterns.
...
- [Docker & Container Guardrails](https://arieradle.github.io/shekel/1.2.0/docker/index.md) - Using `shekel run` in Docker
- [Supported Models](https://arieradle.github.io/shekel/1.2.0/models/index.md) - Full model list with pricing
- [Installation](https://arieradle.github.io/shekel/1.2.0/installation/index.md) - Installing CLI tools
- [Basic Usage](https://arieradle.github.io/shekel/1.2.0/usage/basic-usage/index.md) - Using budgets in code
