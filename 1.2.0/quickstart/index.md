...
[Learn more about nested budgets →](https://arieradle.github.io/shekel/1.2.0/usage/nested-budgets/index.md)
...
- [Loop Guard →](https://arieradle.github.io/shekel/1.2.0/usage/loop-guard/index.md)
- [Spend Velocity →](https://arieradle.github.io/shekel/1.2.0/usage/spend-velocity/index.md)
...
See [CrewAI Integration](https://arieradle.github.io/shekel/1.2.0/integrations/crewai/index.md) for the full reference.
...
- **[CLI Reference](https://arieradle.github.io/shekel/1.2.0/cli/index.md)** - Full `shekel run` options, flags, and exit codes
- **[Docker & Containers](https://arieradle.github.io/shekel/1.2.0/docker/index.md)** - Entrypoint patterns, env vars, JSON logging
- **[Nested Budgets](https://arieradle.github.io/shekel/1.2.0/usage/nested-budgets/index.md)** - Hierarchical tracking for multi-stage workflows
- **[Budget Enforcement](https://arieradle.github.io/shekel/1.2.0/usage/budget-enforcement/index.md)** - Learn about hard caps, warnings, and callbacks
- **[Fallback Models](https://arieradle.github.io/shekel/1.2.0/usage/fallback-models/index.md)** - Automatic model switching
- **[Streaming](https://arieradle.github.io/shekel/1.2.0/usage/streaming/index.md)** - Budget tracking for streaming responses
- **[API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md)** - Complete API documentation
- **[Integrations](https://arieradle.github.io/shekel/1.2.0/integrations/langgraph/index.md)** - Framework-specific guides
...
Yes! Use the `price_per_1k_tokens` parameter to provide custom pricing. See [Extending Shekel](https://arieradle.github.io/shekel/1.2.0/extending/index.md) for details.
