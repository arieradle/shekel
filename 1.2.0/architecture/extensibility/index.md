...
- **New LLM provider**: Implement `ProviderAdapter` in a new module, register with `ADAPTER_REGISTRY`. See [Extending Shekel](https://arieradle.github.io/shekel/1.2.0/extending/index.md).
