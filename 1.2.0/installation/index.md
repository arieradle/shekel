...
See the [CLI Reference](https://arieradle.github.io/shekel/1.2.0/cli/index.md) and [Docker & Containers](https://arieradle.github.io/shekel/1.2.0/docker/index.md) for full details.
...
See [Extending Shekel](https://arieradle.github.io/shekel/1.2.0/extending/index.md) for more details.

## Next Steps

- [Quick Start Guide](https://arieradle.github.io/shekel/1.2.0/quickstart/index.md) - Get started with basic examples
- [Basic Usage](https://arieradle.github.io/shekel/1.2.0/usage/basic-usage/index.md) - Learn the fundamentals
- [API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md) - Full API documentation
