...
- [CrewAI Integration](https://arieradle.github.io/shekel/1.2.0/integrations/crewai/index.md) — per-agent and per-task circuit breaking
- [LangGraph Integration](https://arieradle.github.io/shekel/1.2.0/integrations/langgraph/index.md) — per-node circuit breaking
- [Loop Guard](https://arieradle.github.io/shekel/1.2.0/usage/loop-guard/index.md) — detect and stop agent loops
