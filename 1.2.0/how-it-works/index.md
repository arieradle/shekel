...
To add a new provider, implement `ProviderAdapter` and register it — see [Extending Shekel](https://arieradle.github.io/shekel/1.2.0/extending/index.md).
...
- [Extending Shekel](https://arieradle.github.io/shekel/1.2.0/extending/index.md) - Add new providers or models
- [Contributing](https://arieradle.github.io/shekel/1.2.0/contributing/index.md) - Contribute to the project
- [API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md) - Complete API docs
