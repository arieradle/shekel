...
- **[Basic Usage](https://arieradle.github.io/shekel/1.2.0/usage/basic-usage/index.md)** - Context manager patterns
- **[Accumulating Budgets](https://arieradle.github.io/shekel/1.2.0/usage/accumulating-budgets/index.md)** - Multi-session tracking
- **[API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md)** - Complete decorator parameters
