...
- **[Budget Enforcement](https://arieradle.github.io/shekel/1.2.0/usage/budget-enforcement/index.md)** - More on limits and warnings
- **[API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md)** - Complete fallback parameters
