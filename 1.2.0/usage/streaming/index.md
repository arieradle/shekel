...
With streaming, shekel can only check the budget **after** the full stream completes. The stream will complete even if it exceeds the budget, and the error is raised afterward. Use [fallback models](https://arieradle.github.io/shekel/1.2.0/usage/fallback-models/index.md) for better control.
...
- **[Decorators](https://arieradle.github.io/shekel/1.2.0/usage/decorators/index.md)** - Using @with_budget for cleaner code
- **[Basic Usage](https://arieradle.github.io/shekel/1.2.0/usage/basic-usage/index.md)** - Non-streaming examples
- **[API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md)** - Complete streaming parameters
