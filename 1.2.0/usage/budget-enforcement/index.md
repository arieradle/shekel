...
When `max_usd` is exceeded, shekel raises an exception immediately. The current API call completes, but no further calls are made. Use [fallback models](https://arieradle.github.io/shekel/1.2.0/usage/fallback-models/index.md) if you want to continue with a cheaper model instead.
...
Instead of manually catching and retrying, consider using [fallback models](https://arieradle.github.io/shekel/1.2.0/usage/fallback-models/index.md) for automatic model switching.
...
- **[Fallback Models](https://arieradle.github.io/shekel/1.2.0/usage/fallback-models/index.md)** - Automatic model switching instead of raising
- **[Accumulating Budgets](https://arieradle.github.io/shekel/1.2.0/usage/accumulating-budgets/index.md)** - Multi-session tracking
- **[API Reference](https://arieradle.github.io/shekel/1.2.0/api-reference/index.md)** - Complete budget() parameters
