...
Use the right backend for your context
...
1. Checks all counters atomically against their limits
1. Commits all counters atomically (or rejects all)
...
Config Mismatches in Rolling Deployments
...
See [Docker & Containers](https://arieradle.github.io/shekel/1.2.0/docker/index.md) for a full production setup.
...
See **[Per-Tenant Budgets](https://arieradle.github.io/shekel/1.2.0/usage/per-tenant-budgets/index.md)** for the full guide, including quota management methods and the `shekel tenants` CLI.

______________________________________________________________________

## Next Steps

- **[Per-Tenant Budgets](https://arieradle.github.io/shekel/1.2.0/usage/per-tenant-budgets/index.md)** - Per-user spend isolation for SaaS apps
- **[Temporal Budgets](https://arieradle.github.io/shekel/1.2.0/usage/temporal-budgets/index.md)** - Rolling-window budget fundamentals
- **[Docker & Containers](https://arieradle.github.io/shekel/1.2.0/docker/index.md)** - Full containerized production setup
