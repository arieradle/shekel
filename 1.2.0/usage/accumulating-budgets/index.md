...
- **[Nested Budgets](https://arieradle.github.io/shekel/1.2.0/usage/nested-budgets/index.md)** - Hierarchical budget tracking
- **[Streaming](https://arieradle.github.io/shekel/1.2.0/usage/streaming/index.md)** - Budget tracking for streaming responses
- **[Decorators](https://arieradle.github.io/shekel/1.2.0/usage/decorators/index.md)** - Using @with_budget
